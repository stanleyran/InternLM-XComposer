...
export DATA_PATH=/export/share/shu_zhang/data/ShareGPT4V/coco_only_pretrain.json
# You should download the pretrained projector from LLaVA-v1.5
export CKPT_PATH=/export/home/sf_gitrepo/InternLM-XComposer/projects/ShareGPT4V/assets/llava1.5_projector/mm_projector.bin 
